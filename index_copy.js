class Index {
  constructor(uniqListIngredients) {
    // call API to get data
    this.recipesApi = new ApiRecipes("./data/recipes.json");
    // this.uniqListIngredients = await uniqListIngredients;
    // console.log(uniqListIngredients);
  }
  ...
  async ingredients() {
    ...
    const uniqListIngredients = this.uniqItem(list1);
    console.log(uniqListIngredients);
    return uniqListIngredients;
  }

  // CREATE DROPDOWN LISTS
  async listIngredients(uniqList) {
    uniqList = await this.uniqListIngredients;
